    ...
    return (
        <footer className="py-16 md:py-32">
            ...
            >
                ...
                {/* Redoing the links array construction properly below */}
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} YoPago, {t('footer.rights')}</span>
            </motion.div>
        </footer>
    )
}
